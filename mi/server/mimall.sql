...
CREATE TABLE `addaily` (
  ...
  `sketch` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `phones` (
  ...
  `showid` int NOT NULL,
  `src` varchar(255) NOT NULL,
  `cartimage` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
